	...
	public MessageSerializer() {
		...
		RuntimeTypeAdapterFactory<Base> typeFactory = RuntimeTypeAdapterFactory.of(Base.class)
				...
				.registerSubtype(GetOptimizationStateMessage.class,
						GetOptimizationStateMessage.TYPE_NAME)
				.registerSubtype(GetOptimizationStatusMessage.class,
						GetOptimizationStatusMessage.TYPE_NAME)
				.registerSubtype(OptimizationStatusMessage.class,
						OptimizationStatusMessage.TYPE_NAME)
				.registerSubtype(OptimizationToolConfiguredMessage.class,
						OptimizationToolConfiguredMessage.TYPE_NAME)

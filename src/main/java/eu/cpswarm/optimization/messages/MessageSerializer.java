...
public class MessageSerializer {
	...
	public MessageSerializer() {
		...
		RuntimeTypeAdapterFactory<Message> typeFactory = RuntimeTypeAdapterFactory.of(Message.class)
				...
				.registerSubtype(OptimizationStartedMessage.class,
						OptimizationStartedMessage.TYPE_NAME)
				.registerSubtype(OptimizationCancelledMessage.class,
						OptimizationCancelledMessage.TYPE_NAME)
				.registerSubtype(OptimizationProgressMessage.class,
						OptimizationProgressMessage.TYPE_NAME)
